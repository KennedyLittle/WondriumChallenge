package com.example.wondriumchallenge.domain.use_case.get_courses
...
class GetCoursesUseCase @Inject constructor(
    ...
    operator fun invoke(): Flow<Resource<List<Course>>> = flow {
        try {
            ...
            emit(Resource.Failure<List<Course>>(e.localizedMessage ?: "Error with the response type!"))
        } catch(e: IOException) {
            emit(Resource.Failure<List<Course>>(e.localizedMessage ?: "There is a network error. Check your internet connection!"))
        }
    }
}